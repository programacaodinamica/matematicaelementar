...
# ╔═╡ 375d1ee4-32d4-4872-9d50-deb15fd75288
using Plots
...
2. $d(p, q) \ge 0$
3. $d(p, q) = d(q, p)$
4. $d(p, q) \le d(p, r) + d(r, q)$ 


"""

# ╔═╡ 0ab1a54c-87d2-4af8-b3c9-f9f29cca607e
md"""
#### Bolas (círcunferências, no plano) sob métricas diferentes
...
# ╔═╡ b312d667-f237-4903-97e4-e4d6beb1e81a
# parte de cima do círculo
f(x) = sqrt(1 - x^2)

# ╔═╡ d5f36a8b-1902-4b8e-ae59-3bd4cfbe438e
# parte de baixo
g(x) = - f(x)

# ╔═╡ 3d0dc859-2358-490a-9e67-d5b38b668629
begin
	x = -1:0.01:1
	plot([x, x], [f.(x), g.(x)], 
		framestyle = :origin, 
